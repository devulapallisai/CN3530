...
file_name1 = './round_robin/response_times_3.txt'
file_name2 = './round_robin/response_times_5.txt'
file_name3 = './round_robin/response_times_7.txt'
...
plt.title("Avg Response time vs Number of clients for round robin algorithm")
