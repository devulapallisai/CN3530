...
file_name1 = './random/response_times_3.txt'
file_name2 = './random/response_times_5.txt'
file_name3 = './random/response_times_7.txt'
...
plt.title("Avg Response time vs Number of clients for random algorithm")
