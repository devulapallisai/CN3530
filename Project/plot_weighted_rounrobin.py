...
file_name1 = './weighted_round_robin/response_times_3.txt'
file_name2 = './weighted_round_robin/response_times_5.txt'
file_name3 = './weighted_round_robin/response_times_7.txt'
...
plt.title("Avg Response time vs Number of clients for weighted round robin algorithm")
