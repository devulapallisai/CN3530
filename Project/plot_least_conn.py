...
file_name1 = './least_connection/response_times_3.txt'
file_name2 = './least_connection/response_times_5.txt'
file_name3 = './least_connection/response_times_7.txt'
...
plt.title("Avg Response time vs Number of clients for Least Connections algorithm")
