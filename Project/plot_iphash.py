...
file_name1 = './ip_hash/response_times_3.txt'
file_name2 = './ip_hash/response_times_5.txt'
file_name3 = './ip_hash/response_times_7.txt'
...
plt.title("Avg Response time vs Number of clients for ip hash algorithm")
